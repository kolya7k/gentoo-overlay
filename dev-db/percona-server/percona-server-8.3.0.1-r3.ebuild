...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-tests-fix-grant_user_lock-test.patch
	"${FILESDIR}"/${PN}-tests-segfault-t-FatalSignalDeathTest.-don-t-have-ou.patch
	"${FILESDIR}"/${PN}-riscv-link-with-libatomic-when-necessary.patch
	"${FILESDIR}"/${PN}-Use-Largest_lock_free_type_selector-on-RISC-V.patch
